...
- [2026-07-07 — Apanhado: padronização de documentação (learnhouse)](padronizacao-documentacao/2026-07-07-apanhado-padronizacao-learnhouse.md) —
  cronologia do que foi construído, mapa de artefatos, verificação de linkagem entre as peças e
  análise comparativa Codex (slim-shape) × Claude (learnhouse) com recomendações de adoção.

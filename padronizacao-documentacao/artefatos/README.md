...
| `scripts/docs-wiki-lint.py` | `scripts/` | Lint determinístico da wiki: doc órfão sem menção em índice/log = FAIL; naming fora do §2 = WARN (migração incremental, `--strict-naming` bloqueia); cobre não-markdown |
